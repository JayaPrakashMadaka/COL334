...
main (int argc, char *argv[])
{
  ...
  Ptr<OutputStreamWrapper> stream = asciiTraceHelper.CreateFileStream ("WestWood.cwnd");
  ns3TcpSocket->TraceConnectWithoutContext ("CongestionWindow", MakeBoundCallback (&CwndChange, stream));

  PcapHelper pcapHelper;
  Ptr<PcapFileWrapper> file = pcapHelper.CreateFile ("WestWood.pcap", std::ios::out, PcapHelper::DLT_PPP);
